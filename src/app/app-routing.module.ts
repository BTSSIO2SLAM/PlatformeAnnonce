...
import { ListAnnonceComponent } from './components/myaccount/categories_account/list-annonce/list-annonce.component';
...
const routes: Routes = [
  ...
  //{ path: 'myaccount/annonces', component: ListAnnonceComponent },
